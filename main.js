...
(function () {
    ...
    messages = [
        ...
        '<div class="animated pulse"> Learn to Say  NO. </div>',
        ...
        '<div class="animated fadeInDown"> Work Even When You Do Not Feel Like It. </div>',
        '<div class="animated fadeInUp"> Journal Daily, Even When It Seems Like There is No  Time. </div>', 
        '<div class="animated fadeInDown"> Set  Activities Outside of Work. </div>'
